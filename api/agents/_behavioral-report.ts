...
function buildPrompt(data: z.infer<typeof behavioralReportSchema>, locale: ReportLocale): string {
  ...
  return `Eres un psicólogo deportivo especializado en ${category === "senior" ? "fútbol profesional" : "fútbol juvenil"}. Generas perfiles conductuales usando lenguaje profesional pero accesible para ${category === "senior" ? "el cuerpo técnico" : "entrenadores de academia"}.
...
## INSTRUCCIONES
Genera un reporte de perfil conductual con las siguientes secciones. Adapta el lenguaje a la edad del jugador y su ${category === "senior" ? "momento de carrera" : "fase de desarrollo"}.
