...
const BehavioralOverviewPage = React.lazy(() => import("./pages/BehavioralOverviewPage"));
const ScanningIntelligencePage = React.lazy(() => import("./pages/ScanningIntelligencePage"));
